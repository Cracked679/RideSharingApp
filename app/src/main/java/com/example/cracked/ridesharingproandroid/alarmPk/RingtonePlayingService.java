package com.example.cracked.ridesharingproandroid.alarmPk;
...
import com.example.cracked.ridesharingproandroid.DetailsOfEvent;
import com.example.cracked.ridesharingproandroid.DetailsOfEventForUser;
...
public  class RingtonePlayingService extends Service {
    ...
    com.example.cracked.ridesharingproandroid.Interfaces.Service service;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        retrofit = new Retrofit.Builder()
                .baseUrl(com.example.cracked.ridesharingproandroid.Interfaces.Service.BASE_URL)
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        service = retrofit.create(com.example.cracked.ridesharingproandroid.Interfaces.Service.class);
